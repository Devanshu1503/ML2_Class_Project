...
# confirm patch count
P = cfg.PATCH_SIZE
n_patches = (cfg.IMAGE_SIZE // P) ** 2
print("patch size         : %d×%d" % (P, P))
print("patches per image  : %d  (%d×%d grid)" % (n_patches, cfg.IMAGE_SIZE // P, cfg.IMAGE_SIZE // P))
print("patch dim (flatt.) : %d" % (P * P * 3))
print()
